...
# python3 steganography.py merge --image1=image1.jpg --image2=image2.jpg --output=output.png
# python3 steganography.py unmerge --image=output.png --output=output2.png
